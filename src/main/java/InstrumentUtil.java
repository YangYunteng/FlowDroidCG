...
public class InstrumentUtil {
    public static final String TAG = "<SOOT_LEARNING>";
...
//        Scene.v().addBasicClass("java.lang.System", SootClass.SIGNATURES);
    ...
    public static List<Unit> generateLogStmts(JimpleBody b, String msg, Value val) {
        ...
        if(val!=null)
            logMsg=InstrumentUtil.appendTwoStrings(b, logMessage, val, generated);
